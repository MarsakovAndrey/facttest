...
<div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
    <p class="sort">Сортировка:
        <a <?if ($_GET["sort"] == "property_PRODUCT_TYPE"):?> class="active" <?endif;?>
                href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=property_RAITING&method=desc">популярность вверх</a>
        <a <?if ($_GET["sort"] == "property_PRODUCT_TYPE"):?> class="active" <?endif;?>
                href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=property_RAITING&method=asc">популярность вниз</a>
